...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "rakefile", "TODO", "examples/cgiform/cgiform.rb", "examples/cgiform/template.rhtml", "examples/hello.rb", "lib/ting.rb", "lib/ting/conversion.rb", "lib/ting/conversions.rb", "lib/ting/conversions/hanyu.rb", "lib/ting/data/comparison.csv", "lib/ting/data/final.csv", "lib/ting/data/initial.csv", "lib/ting/data/paladiy.txt", "lib/ting/data/rules.yaml", "lib/ting/data/valid_ting.yaml", "lib/ting/exception.rb", "lib/ting/groundwork.rb", "lib/ting/string.rb", "lib/ting/support.rb", "lib/ting/tones.rb", "lib/ting/tones/accents.rb", "lib/ting/tones/marks.rb", "lib/ting/tones/no_tones.rb", "lib/ting/tones/numbers.rb", "rakefile", "script/update", "test/test_comparison.rb", "test/test_hanyu_coverage.rb"]
